...
public class BHARSDSProf6 {
	...
	public void move() throws Exception {
	  		...
	  		try {
	  			...
	  			moveFile("D:\\Temp\\"+OR1.getProperty("TC6Name"),"\\\\HPSDEVXESEFST01\\shared\\Pickup\\837\\Inbound\\"+OR1.getProperty("TC6Name"));
	  		} catch (Exception e) {
...
public static void moveFile(String src, String dest ) throws Exception {
 ...
 if(result != null) {
		         System.out.println("TC6: File moved successfully.");
		      }
		      else
		      {
      ...
      //code to take a break of 1 minute between file load and execution on browser
	    ...
	    driver.findElement(By.linkText("BHAR6")).click();
	   ...
	   driver.switchTo().defaultContent();
	    ...
	    try {
	    	if(driver.findElement(By.linkText("BHAR6.277CA")).isDisplayed() )
	    ...
	    driver.findElement(By.xpath("//a[contains(text(),'BHAR6.277CA')]")).click();
	    Thread.sleep(2000);
	    try{
